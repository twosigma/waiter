...
from waiter.subcommands import create, delete, init, kill, maintenance, ping, show, signal, ssh, ssl, tokens, update
...
actions = {
    ...
    'signal': {
        'run-function': signal.register(subparsers.add_parser)
    },
    'ssh': {

...
export INTEGRATION_TEST_CUSTOM_IMAGE_ALIAS_2="alias/p2"
export INTEGRATION_TEST_CUSTOM_IMAGE_ALIAS_CONSTRAINT_ATTRIBUTE_2="platform"
export INTEGRATION_TEST_CUSTOM_IMAGE_ALIAS_CONSTRAINT_VALUE_2="p2"

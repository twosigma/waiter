...
(deftest test-resolve-service-status
  ...
  (is (= :service-state-waiting (resolve-service-status nil {})))
  (is (= :service-state-waiting (resolve-service-status nil {:healthy 0 :requested 0 :scheduled 0})))
  (is (= :service-state-scaling (resolve-service-status nil {:healthy 1 :requested 0 :scheduled 0})))
  (is (= :service-state-starting (resolve-service-status nil {:healthy 0 :requested 1 :scheduled 0})))
  (is (= :service-state-scaling (resolve-service-status nil {:healthy 1 :requested 1 :scheduled 0})))
  (is (= :service-state-starting (resolve-service-status nil {:healthy 0 :requested 0 :scheduled 1})))
  (is (= :service-state-scaling (resolve-service-status nil {:healthy 1 :requested 0 :scheduled 1})))
  ...
  (is (= :service-state-scaling (resolve-service-status nil {:healthy 1 :requested 2 :scheduled 1})))
  (is (= :service-state-scaling (resolve-service-status nil {:healthy 1 :requested 1 :scheduled 2})))
  (is (= :service-state-scaling (resolve-service-status nil {:healthy 2 :requested 2 :scheduled 1})))
  (is (= :service-state-scaling (resolve-service-status nil {:healthy 2 :requested 1 :scheduled 2})))
